...
function Payment() {
    ...
    const handleCashOnDelivey = () => {
            toast.success("Products ordered successfully , Please pay cash at time of delivery", {
                theme: "dark"
            });
            navigate("/")
    }
    ...
    return (
        <div className="payment-page">
            ...
            <div className="grocify-button-container">
                ...
                <button id="pay" className="grocify-button grocify-button-payment payment-btn continue-btn" onClick={() => handleCashOnDelivey()}>
                    <span className="heading" id="pay-btn">Cash on Delivery</span>
                </button>
            </div>
        </div>
    )
