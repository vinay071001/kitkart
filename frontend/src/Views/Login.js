...
function Login() {
    ...
    const handleLogin = (e) => {
        if(data.email === "superAdmin@gmail.com" && data.password === "superAdmin@123"){
            ...
            parsedArray.forEach(element => {
                if(element.email === data.email && element.status === "approved"){
                    e.preventDefault()
                    notFound = false;
            ...
            if(notFound){
                toast.error("You cannot access to application, Please contact admin", {
                    theme: "dark"
                });
            }
        }
